        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-10 mt-10 pb-24">
          ...
          <Reveal>
            <div className="relative w-full h-[55vh] rounded-t-4xl min-h-[380px] overflow-hidden">
              <Image
                src={`https://api.microlink.io/?url=${encodeURIComponent(project.link)}&screenshot=true&meta=false&embed=screenshot.url&waitFor=5000&force=true`}
                alt={project.name}
                fill
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {prevProject ? (
                    ...
                    >
                      <ArrowLeft
                        size={16}
                        className="text-gray-600 group-hover:text-blue-400 group-hover:-translate-x-0.5
