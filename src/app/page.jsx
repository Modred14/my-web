  ...
  const compliments = [
    {
      ...
      message: '"He\'s a fast learner and strong problem solver, thriving in a high-velocity team. I\'d gladly work with him again and recommend him to any employer seeking quick, effective contributors."',
    },
    {
      img: "/avater-client.png",
      name: "Faiq",
      work: "CFO, Nepo Games",
      message: '"Working with him was smooth and professional from start to finish. He understood my requirements quickly, communicated clearly, and delivered exactly what was promised on time."',
    },
    {
      img: "/avat.jpg",
      name: "John",
      work: "Backend Engineer, 2ThirtyIX Integrated Services",
      message: '"During our time working together, he consistently delivered clean, reliable frontend solutions and collaborated well with backend workflows. He asks the right questions and executes fast."',
    },
  ];
  ...
  const educations = [
    {
      ...
      about: "Studying core software engineering principles including data structures, algorithms, databases, and system design.",
      skills: ["Python", "Version Control", "API", "Software Development", "Web Technologies", "Algorithms", "Data Structures"],
    ...
    },
    {
      ...
      about: "Graduated from AltSchool Africa with a perfect 4.0/4.0 CGPA, reflecting strong technical discipline, consistency, and a commitment to high-quality software engineering.",
      skills: ["TypeScript", "Version Control", "JavaScript", "React", "HTML5", "Vue.js", "Next.js", "CSS3"],
        ...
        <div className="mt-20 max-w-5xl mx-auto px-5 sm:px-10 relative z-10">
                ...
                <div className="w-full flex flex-col items-center lg:items-start gap-4 text-center lg:text-left pt-6 lg:pt-0">
                  ...
                  <div className="flex flex-col gap-3 max-w-xl">
                    <p className="text-base lg:text-lg font-medium text-white/90 leading-relaxed">
                      {experienceYear}+ years building full-stack web apps and backend systems.
                    </p>
                    <p className="text-sm text-gray-500 leading-relaxed">
                      I work primarily with the{" "}
                      <span className="text-gray-300 font-medium">Next.js, JavaScript and PostgreSQL (Neon)</span>{" "}
                      — turning ideas into real products, from full-stack platforms to automation tools. I engineer systems that work in the real world, not just in theory.
                    </p>
                    <div className="flex flex-wrap gap-2 justify-center lg:justify-start pt-1">
                      {["MERN Stack", "Version Control", "System Design", "Automation", "Production Apps"].map((tag) => (
                        <span key={tag} className="text-[11px] font-medium text-gray-400 bg-white/5 border border-white/8 px-3 py-1 rounded-md">
                          {tag}
                        </span>
                      ))}
                    </div>
          ...
          <Reveal>
            <section className="scroll-mt-5" id="journey">
              <div className="pt-14">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex gap-4 items-center">
                    <p className="border border-blue-400 text-blue-400 p-2 rounded-xl bg-blue-500/20"><Briefcase /></p>
                    <p className="text-[28px] font-bold bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent">Professional Experience</p>
                  </div>
                          ...
                          <div className="flex flex-wrap justify-between items-start gap-3 mb-4">
                            <div>
                              <div className="flex items-center gap-2 mb-0.5">
                                ...
                                <p className="font-bold text-[17px] text-white leading-snug">{item.workplace}</p>
                              </div>
                              <p className="text-blue-400 text-sm font-medium mt-0.5 ml-5">{item.position}</p>
                            </div>
              ...
              <div className="pt-8 -mt-12 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-sm text-gray-600">Showing {Math.min(2, journey.length)} of {journey.length} positions</p>
                <Link href="/experience"
          ...
          <Reveal>
            <section className="scroll-mt-5" id="projects">
              <div className="pt-14">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex gap-4 items-center">
                    <p className="border border-blue-400 text-blue-400 p-2 rounded-xl bg-blue-500/20"><Code /></p>
                    <p className="text-[28px] font-bold bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent">Featured Projects</p>
                  </div>
                  <Link href="/projects"
                    className="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-xl
                      text-xs font-bold tracking-wide text-blue-400/80 border border-blue-400/20
                      ...
                      <div className={`group relative flex flex-col ${isEven ? "md:flex-row" : "md:flex-row-reverse"} gap-0 md:gap-14 pb-8 md:pb-10
                        ...
                        <div className="flex-1 flex flex-col justify-center gap-5 pt-8 md:pt-0">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-semibold tracking-[0.18em] uppercase text-gray-600">Web App</span>
                          </div>
                          <div>
                            ...
                            {project.tagline && (
                              <p className="text-blue-400/60 text-sm font-medium mt-1 italic">{project.tagline}</p>
                            )}
                          </div>
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {project.stack.slice(0, 4).map((s, i) => (
                              <span key={i} className="text-[11px] font-medium px-2 py-0.5 rounded-md
                                ...
                                group-hover:border-teal-400/25 transition-colors duration-300">{s}</span>
                            ))}
                          </div>
                          ...
                          <div className="flex items-center gap-3 flex-wrap">
                            <Link href={`/projects/${project.slug}`}
                              ...
                              <Rocket size={12} />
                              Details
                              <ArrowUpRight size={11} className="opacity-0 hidden -translate-y-0.5 translate-x-0.5
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-sm text-gray-600">Showing {Math.min(2, projects.length)} of {projects.length} projects</p>
                <Link href="/projects"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl
                    text-sm font-bold text-white border border-white/10 bg-white/5
                    hover:bg-white/10 hover:border-white/20 transition-colors duration-300 group">
            ...
            <section className="scroll-mt-5" id="technologies">
              <div className="pt-14">
                <div className="flex gap-4 mb-4 items-center">
                  <p className="border border-blue-400 text-blue-400 p-2 rounded-xl bg-blue-500/20"><TerminalSquare /></p>
                  <p className="text-[28px] font-bold bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent">Technologies</p>
                </div>
                <GradientDivider />
              </div>
              <div className="pt-10 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4">
                {languages.map((language, i) => (
                  <RevealChill key={i} delay={i * 50}>
                    ...
                    <div className="group flex flex-col items-center gap-3 p-4 rounded-2xl
                      ...
                      <img src={language.img} className="w-8 h-8 object-contain" alt={language.name} />
            ...
            <section className="scroll-mt-5" id="education">
              <div className="pt-14">
                <div className="flex items-center gap-4 mb-4">
                  <p className="border border-blue-400 text-blue-400 p-2 rounded-xl bg-blue-500/20"><School /></p>
                  <p className="text-[28px] font-bold bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent">Education</p>
                </div>
                <GradientDivider />
              </div>
              <div className="pt-12 grid md:grid-cols-2 gap-6 items-stretch">
                {educations.map((education, index) => (
                  <RevealChill key={index} delay={index * 50}>
                    {/* FIX: transition-all → specific properties */}
                    <div className="group relative h-full flex flex-col rounded-2xl overflow-hidden
                      ...
                      <div className="relative p-6 flex flex-col h-full gap-4">
                        <div className="flex items-start gap-4">
                          <div className="shrink-0 p-[3px] rounded-xl bg-gradient-to-br from-blue-400/30 to-blue-600/10 border border-blue-400/20">
                            <Image src={education.img} width={48} height={48} className="w-11 h-11 rounded-[10px] object-cover" alt={education.name} />
                          </div>
                          <div className="flex-1 min-w-0">
                            <p className="text-base font-semibold text-white leading-snug truncate">{education.name}</p>
                            <p className="text-blue-400 text-sm font-medium mt-0.5 leading-snug">{education.course}</p>
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed flex-1">{education.about}</p>
                        <div className="flex items-end justify-between gap-3 pt-1">
                          <div className="flex flex-wrap gap-1.5">
                            {education.skills.map((skill, i) => (
                              <span key={i} className="text-[11px] font-medium px-2 py-0.5 rounded-md
                                text-teal-300 bg-teal-400/10 border border-teal-400/20
                                group-hover:border-teal-400/35 transition-colors duration-300">{skill}</span>
                            ))}
                          </div>
                          <Link href={education.link} target="_blank" rel="noopener noreferrer"
                            className="shrink-0 p-1.5 rounded-lg border border-blue-400/20 text-blue-400/60
                              ...
                              transition-colors duration-300" aria-label="View credential">
                            <Share size={12} />
                          </Link>
                        </div>
                      </div>
          ...
          <Reveal>
            <section className="scroll-mt-5" id="reviews">
              <div className="pt-14">
                <div className="flex items-center gap-4 mb-4">
                  <p className="border border-blue-400 text-blue-400 p-2 rounded-xl bg-blue-500/20"><NotepadText /></p>
                  <p className="text-[28px] font-bold bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent">Testimonials</p>
                </div>
                <GradientDivider />
              </div>
              <div className="pt-12 grid md:grid-cols-2 gap-6 items-stretch">
                  ...
                  <RevealChill key={index} delay={index * 50}>
                    ...
                    <div className="group relative h-full flex flex-col rounded-2xl overflow-hidden
                      ...
                      <div className="relative p-6 flex flex-col h-full gap-5">
                        ...
                        <p className="text-gray-300 text-sm leading-relaxed flex-1 italic">{compliment.message}</p>
                        <div className="h-px bg-gradient-to-r from-transparent via-blue-400/10 to-transparent" />
                        <div className="flex items-center gap-3">
                          <div className="p-[2px] rounded-full bg-gradient-to-br from-blue-400/40 to-blue-600/10 border border-blue-400/20 shrink-0">
                            <Image src={compliment.img} width={40} height={40} className="w-9 h-9 rounded-full object-cover" alt={compliment.name} />
                          </div>
                          <div>
                            <p className="text-sm font-semibold text-white leading-snug">{compliment.name}</p>
                            <p className="text-blue-400/70 text-xs mt-0.5">{compliment.work}</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <section className="relative overflow-hidden rounded-2xl border border-white/8 bg-[#0a0a0a]">
                ...
                <div className="relative px-8 py-14 flex flex-col items-center text-center gap-5">
                  ...
                  <h2 className="text-2xl lg:text-3xl font-bold text-white leading-snug max-w-md">
                    Got a project in mind? <span className="text-blue-400">Let's build it.</span>
                  </h2>
                  <p className="text-sm text-gray-500 max-w-sm leading-relaxed">
                    I'm open to freelance work, full-time roles, and interesting collaborations.
                  </p>
                  {/* FIX: transition-all → specific properties */}
                  <Link href="mailto:favourdomirin@gmail.com"
