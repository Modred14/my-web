...
export default function Home() {
  ...
  return (
    ...
    "
          ...
          {/* ── Experience ── */}
          <Reveal>
            <section className="scroll-mt-8 px-5" id="journey">
              <div className="pt-14">
          ...
          {/* ── Technologies ── */}
          <Reveal>
            <section className="scroll-mt-8 px-5" id="technologies">
              <div className="pt-14">
          ...
          {/* ── Education ── */}
          <Reveal>
            <section className="scroll-mt-8 px-5" id="education">
              <div className="pt-14">
          ...
          {/* ── Testimonials ── */}
          <Reveal>
            <section className="scroll-mt-8 px-5" id="reviews">
              <div className="pt-14">
                <div className="flex items-center gap-4 mb-4">
                  <p className="border border-blue-400 text-blue-400 p-2 rounded-xl bg-blue-500/20">
                    <NotepadText />
          ...
          <div className="pt-14">
            <Reveal>
              <section className="px-5 relative overflow-hidden rounded-2xl border border-white/8 bg-[#0a0a0a]">
                <div
