export const projects = [
  ...
  },
  {
    ...
    about:
      "A peer-to-peer escrow and delivery coordination platform where payment is locked the moment a buyer pays and only released once delivery is confirmed by QR scan.",
    description: [
      "Peer-to-peer trading between strangers has the same problem as game account trading — someone has to go first, and that's exactly where scams happen. EscrowGo was built to remove that risk from any physical goods trade, not just a single niche.",
      "A seller creates a deal with product details, photos, both parties' locations, an estimated delivery window, and a delivery method — either an EscrowGo courier or self-delivery. A shareable payment link is generated for the buyer.",
      "Once the buyer pays through Nomba, the deal moves to a funds-held state — the money is locked in escrow rather than sent straight to the seller. Delivery then happens either through an assigned courier (accept, pick up, deliver) or the seller directly.",
      "The moment delivery is marked complete, the buyer receives a one-time QR code. The seller or courier scans that code from their own dashboard to prove delivery actually happened, and only then is escrow released to the seller. A cron-protected sweep also auto-refunds the buyer if the delivery date passes with no confirmation, so no one is left stuck either way.",
    ],
    highlights: [
      "Escrow payment system — funds locked via Nomba until delivery is verified",
      "One-time QR code generated on delivery, required to release payment",
      "Camera-based QR scanning to confirm and authorize release",
      "Dual delivery paths — assigned couriers or self-delivery by the seller",
      "Courier flow — accept, pick up, deliver, and get paid out",
      "Automatic buyer refund if the delivery window passes unconfirmed",
      "Seller earnings dashboard with PDF export",
      "Admin panel with platform-wide stats and transaction oversight",
      "Cloudinary-backed product photo uploads",
      "Built solo — full-stack and backend",
    ],
    link: "https://escrow-go.netlify.app",
    github: "https://github.com/Modred14/EscrowGo",
    img: "/escrowgo.png",
  },
  {
    slug: "tappay",
  ...
  },
  {
    ...
    slug: "voice-script",
    name: "VoiceScript",
    tagline: "Turn speech into text. Instantly.",
    stack: [
      "React",
      "Vite",
      "Python",
    ...
    about:
      "An open-source speech-to-text web app that transcribes microphone recordings and audio files into editable text using Groq's Whisper Large v3 Turbo API.",
    description: [
    ...
    link: "https://voice-script.netlify.app",
    github: "https://github.com/Modred14/speech-to-text",
    img: "/voice-script.png",
  },
  {
    slug: "scissors",
    name: "Scissors",
  ...
  },
  {
    ...
    about: "A fully anonymous feedback platform built for the NACOS OAU Chapter, enabling students to share honest opinions, suggestions and ideas anonymously.",
    description: [
