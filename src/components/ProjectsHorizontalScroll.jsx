  ...
  return (
   ...
   <div
      ...
      >
        ...
        >
          {/* ambient glow — pointer-fine only; 100px blurs cost real frames on
              phones and this section is scroll-driven the whole way through */}
          ...
          >
            {/* edge fades so cards dissolve into the page instead of cutting off */}
                ...
                {projects.map((_, i) => (
                  <span
                    ...
                    className={`h-1.5 rounded-full transition-[width,background-color] duration-300 ${
                      i === activeIndex ? "w-6 bg-blue-400" : "w-1.5 bg-white/15"
                    }`}
                  />
                ))}
              </span>
